...
<html lang="en">
   ...
   <head>
      ...
      <!-- [Favicon] icon -->
      <link rel="icon" href="{{ asset('user/assets/images/fev.png')}}" type="image/x-icon" />
      <!-- [Google Font : Public Sans] icon -->
      <link href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@400;500;600;700&display=swap" rel="stylesheet" />
      <!-- [phosphor Icons] https://phosphoricons.com/ -->
      <link rel="stylesheet" href="{{ asset('user/assets/fonts/phosphor/duotone/style.css')}}" />
      <!-- [Tabler Icons] https://tablericons.com -->
      <link rel="stylesheet" href="{{ asset('user/assets/fonts/tabler-icons.min.css')}}" />
      <!-- [Feather Icons] https://feathericons.com -->
      <link rel="stylesheet" href="{{ asset('user/assets/fonts/feather.css')}}" />
      <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
      <link rel="stylesheet" href="{{ asset('user/assets/fonts/fontawesome.css')}}" />
      <!-- [Material Icons] https://fonts.google.com/icons -->
      <link rel="stylesheet" href="{{ asset('user/assets/fonts/material.css')}}" />
      <!-- [Template CSS Files] -->
      <link rel="stylesheet" href="{{ asset('user/assets/css/style.css')}}" id="main-style-link" />
         ...
         <div class="navbar-wrapper">
            <div class="m-header">
               <a href="{{route('user.dashboard')}}" class="b-brand text-primary">
                  ...
                  <img src="{{ asset('user/assets/images/Logo.png')}}"  alt="logo image" class="main_logo" /> 
               </a>
            </div>
            <div class="navbar-content">
               ...
               <li class="pc-item pc-hasmenu ">
                  <a href="{{ route('user.project.new') }}" class="pc-link">
                     <span class="pc-micon">
                     ...
                     <span class="pc-mtext" >New Projects</span> 
                  </a>
               </li>

               <li class="pc-item pc-hasmenu ">
                  <a href="{{ route('user.project.ongoing') }}" class="pc-link">
                     <span class="pc-micon">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-folder"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2" /></svg>
                     </span>
                     <span class="pc-mtext" >Ongoing Projects</span> 
                  </a>
               </li>

               <li class="pc-item pc-hasmenu ">
                  <a onclick="costing_pop()" class="pc-link">
                     <span class="pc-micon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-brand-my-oppo"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M18.316 5h-12.632l-3.418 4.019a1.089 1.089 0 0 0 .019 1.447l9.714 10.534l9.715 -10.49a1.09 1.09 0 0 0 .024 -1.444l-3.422 -4.066z"></path><path d="M9 11l3 3l3 -3"></path></svg>
                     </span>
                     <span class="pc-mtext">Become a Member</span> 
                  </a>
               </li>
               ...
               <ul class="list-unstyled">
                              ...
                              <li class="list-group-item">
                                 <div class="d-flex">
                                    <div class="flex-shrink-0">
                                       <img src="{{ asset('user/assets/images/user/avatar-2.jpg')}}" alt="user-image" class="user-avtar avtar avtar-s" />
                                    </div>
                  ...
                  <li class="dropdown pc-h-item header-user-profile">
                     <a
                        ...
                        aria-expanded="false"
                        >
                     <img src="{{ asset('user/assets/images/user/avatar-2.jpg')}}" alt="user-image" class="user-avtar" />
                     </a>
                              ...
                              <ul class="list-group list-group-flush w-100">
                                 <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                       <div class="flex-shrink-0">
                                          <img src="{{ asset('user/assets/images/user/avatar-2.jpg')}}" alt="user-image" class="wid-50 rounded-circle" />
                                       </div>
