<div id="costing_pop" class="modal img_pop">
    <div class="modal-content">
      <span class="close" onclick="closeModal_costing()">&times;</span>
      <h2>Become a Member</h2>
      <div class="pop_divdr"></div>
      <div class="clear"></div>
      <div class="card-body" bis_skin_checked="1">

         <div class="col-md-6 col-xxl-6" bis_skin_checked="1">
                  <div class="card price-card" bis_skin_checked="1">
                    <div class="card-body price-head bg-light-primary" bis_skin_checked="1">
                      <h5 class="text-primary">Lite</h5>
                      <h2 class="price-price text-primary">$ 19,17€<span>/month</span></h2>
                      <div class="price-icon bg-light-primary" bis_skin_checked="1">
                        <i class="ph-duotone ph-rocket text-primary"></i>
                      </div>
                    </div>
                    <div class="card-body" bis_skin_checked="1">
                      <ul class="list-unstyled product-list">
                        <li class="enable"><i class="ph-duotone ph-check-circle"></i>Information Points</li>
                        <li class="enable"><i class="ph-duotone ph-check-circle"></i>Information Points</li>
                        <li class="enable"><i class="ph-duotone ph-check-circle"></i>Information Points</li>
                        <li class="enable"><i class="ph-duotone ph-check-circle"></i>Information Points</li>
                        <li class="enable"><i class="ph-duotone ph-check-circle"></i>Information Points</li>
                ...
                <div class="col-md-6 col-xxl-6" bis_skin_checked="1">
                  <div class="card price-card" bis_skin_checked="1">
                    <div class="card-body price-head bg-light-secondary" bis_skin_checked="1">
                      <h5 class="text-secondary">Standard</h5>
                      <h2 class="price-price text-secondary">230€<span>/Year</span></h2>
                      <div class="price-icon bg-light-secondary" bis_skin_checked="1">
 ...
 <div id="myModal_img" class="modal img_pop">
  ...
  <script>
    ...
    <script>
    // Open Modal
    function costing_pop() {
      document.getElementById("costing_pop").style.display = "block";
    }

    // Close Modal
    function closeModal_costing() {
      document.getElementById("costing_pop").style.display = "none";
    }

    // Close if clicked outside modal content
    window.onclick = function(event) {
      let modal = document.getElementById("costing_pop");
      if (event.target === modal) {
        closeModal_costing();
      }
    }
