                    ...
                    <table id="row-callback" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.user.edit', $user->id)}}" class="edit_movie" >
                                ...
                                <td>
                                    <button type="button" class="btn btn-link p-0 m-0 border-0 bg-transparent" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $user->id }}">
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $user->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $user->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                Are you sure you want to delete <strong>{{ $user->details->first_name }}</strong>?
                                                </div>
